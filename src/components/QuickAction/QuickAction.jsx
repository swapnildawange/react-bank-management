...
function QuickAction() {
  ...
  return (
    <div className="grid place-items-center ">
      <div className="max-w-md flex flex-col  max-h-screen px-8 ">
        ...
        <div className="grid gap-4 grid-cols-2 grid-rows-2 place-items-center mt-4 ">
          <div
            className="grid place-items-center cursor-pointer cursor-pointer"
            onClick={() => navigate("/withdraw")}
          >
            <ActionIcon
              children={<RemoveCircleOutlineIcon fontSize="large" />}
            />
            <h1 className="text-lg font-semibold mt-2 text-gray-500">
              Withdraw
            </h1>
          </div>
          <div
